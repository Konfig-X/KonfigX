KERNEL_API_URL="https://api.github.com/repos/Konfig-X/atlas-ui8/releases/latest"
...
KERNEL_DL_BASE="https://github.com/Konfig-X/atlas-ui8/releases/download/$LATEST_TAG"
...
KERNEL_ARCHIVE="$(
    curl -s "$KERNEL_API_URL" \
    | grep -oE "Atlas-.*_${TARGET_CODENAME}_VANILLA_UNOFFICIAL_.*\.zip" \
    | sort -u \
    | tail -n 1
)"
